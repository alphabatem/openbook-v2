...
impl TestContext {
    ...
    pub async fn new_with_market(
        ...
        let tokens = Token::create(mints.to_vec(), solana, collect_fee_admin_acc, payer, false).await;
    ...
    pub async fn new_with_market_v2(
        ...
        let tokens = Token::create(mints.to_vec(), solana, collect_fee_admin_acc, payer, true).await;
